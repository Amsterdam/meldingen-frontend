...
The number makes ADRs referenceable from code comments and PRs, and keeps them ordered from oldest to newest. The verb phrase names the decision itself — what was chosen — not the topic that was evaluated. A reader scanning the list can immediately see what was decided without opening the file.
