...
export const startUpload = (
  ...
  xhr.onloadend = () => {
    // Remove any existing validation error for this upload e.g. remove "pending upload" error
    setValidationErrors((errors) => errors.filter((error: { key: string }) => error.key !== fileUpload.id))
  }
