  ...
  resources: {
    'asset-type': {
      fields: {
        ...
        'arguments.icon_entry': 'Koppelcode',
        'arguments.icon_folder': 'Folder',
        'arguments.label': 'Label',
        'arguments.location_description': 'Beschrijving',
        'arguments.location_label': 'Vraagtekst',
        'arguments.location_required_error': 'Foutmelding verplichte vraag',
        'arguments.plural': 'Meervoud asset',
        'arguments.singular': 'Enkelvoud asset',
    ...
    classification: {
      fields: {
        ...
        name: 'Naam',
        service_level_objective_day_type: 'Type dagen',
        service_level_objective_day_type_calendar_days: 'Alle dagen (ma-zo)',
        service_level_objective_day_type_working_days: 'Werkdagen (ma-vr)',
        service_level_objective_days: 'Afhandeltermijn in dagen',
        service_level_objective_text: 'Servicebelofte',
      },
