export const ENDPOINTS = {
  ...
  MELDING_ATTACHMENTS_BY_ID: 'http://localhost:8000/melding/:meldingId/attachments',
  MELDING_ATTACHMENT_BY_ID_DOWNLOAD: 'http://localhost:8000/melding/:meldingId/attachment/:attachmentId/download',
  MELDING_ATTACHMENT_DELETE_BY_ID: 'http://localhost:8000/melding/:meldingId/attachment/:attachmentId',
