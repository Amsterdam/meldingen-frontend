...
export const generateMetadata = async () => {
  const t = await getTranslations('primary-form')
...
export default async () => {
  ...
  // TODO
  const requiredErrorMessage = primaryTextArea.validate?.required_error_message ?? ''

  const action = postPrimaryForm.bind(null, { requiredErrorMessage })

  return <PrimaryForm action={action} primaryTextArea={primaryTextArea} />
}
