...
export type PrimaryFormInput = {
  title: string
  components: Array<FormPanelComponentInput | FormComponentInput>
}

export type PrimaryFormOutput = {
  title: string
  display: string
  components: Array<FormComponentOutput | FormPanelComponentOutput>
}
...
export type GetFormPrimaryResponse = PrimaryFormOutput

export type PutFormPrimaryData = {
  requestBody: PrimaryFormInput
}

export type PutFormPrimaryResponse = PrimaryFormOutput
