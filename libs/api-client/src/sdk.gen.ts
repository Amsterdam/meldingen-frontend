 ...
 */
export const patchMeldingByMeldingIdMelder = <ThrowOnError extends boolean = false>(options: Options<PatchMeldingByMeldingIdMelderData, ThrowOnError>) => (options.client ?? client).patch<PatchMeldingByMeldingIdMelderResponses, PatchMeldingByMeldingIdMelderErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/melding/{melding_id}/melder',
    ...options,
    headers: {
 ...
 */
export const deleteMeldingByMeldingIdAnswerByAnswerId = <ThrowOnError extends boolean = false>(options: Options<DeleteMeldingByMeldingIdAnswerByAnswerIdData, ThrowOnError>) => (options.client ?? client).delete<DeleteMeldingByMeldingIdAnswerByAnswerIdResponses, DeleteMeldingByMeldingIdAnswerByAnswerIdErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * Label:List
 */
export const getLabel = <ThrowOnError extends boolean = false>(options?: Options<GetLabelData, ThrowOnError>) => (options?.client ?? client).get<GetLabelResponses, GetLabelErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/label/',
    ...options
});
 ...
 * Llm Eval:Run
 */
export const postLlmEvalRun = <ThrowOnError extends boolean = false>(options: Options<PostLlmEvalRunData, ThrowOnError>) => (options.client ?? client).post<PostLlmEvalRunResponses, PostLlmEvalRunErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/llm-eval/run',
    ...options,
    headers: {
