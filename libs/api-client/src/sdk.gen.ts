...
export const getAttachmentById = <ThrowOnError extends boolean = false>(options: Options<GetAttachmentByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetAttachmentByIdResponse, GetAttachmentByIdError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const postMailPreview = <ThrowOnError extends boolean = false>(options: Options<PostMailPreviewData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostMailPreviewResponse, PostMailPreviewError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getMeldingByMeldingIdAttachmentByAttachmentIdDownload = <ThrowOnError extends boolean = false>(options: Options<GetMeldingByMeldingIdAttachmentByAttachmentIdDownloadData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetMeldingByMeldingIdAttachmentByAttachmentIdDownloadResponse, GetMeldingByMeldingIdAttachmentByAttachmentIdDownloadError, ThrowOnError>({
