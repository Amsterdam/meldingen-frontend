...
export const FormTextAreaComponentOutputSchema = {
    ...
    type: 'object',
    required: ['label', 'description', 'key', 'type', 'input', 'position', 'autoExpand', 'showCharCount', 'question'],
...
export const StaticFormTextAreaComponentOutputSchema = {
    ...
    type: 'object',
    required: ['label', 'description', 'key', 'type', 'input', 'position', 'autoExpand', 'showCharCount'],
